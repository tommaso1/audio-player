...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{au: false, aw: r.aw, E: r.E, T: r.T, aE: r.aE, aP: r.aP, ao: r.ao, M: r.M}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{aw: $elm$http$Http$emptyBody, E: r.E, T: _List_Nil, aE: 'GET', aP: $elm$core$Maybe$Nothing, ao: $elm$core$Maybe$Nothing, M: r.M});
};
...
var $author$project$AudioPage$viewAudioPage = function (model) {
	var second = $author$project$AudioPage$formatSeconds(
		A2($elm$core$Basics$modBy, 60, model.ak));
	var minutes = $author$project$AudioPage$formatSeconds((model.ak / 60) | 0);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('margin-top-2')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Durata sessione: 20 minuti')
							]))
					])),
				A2(
				$elm$html$Html$div,
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text(minutes + (':' + second))
											]))
									]))
							]))
					])),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('smile-container')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Msg$Happy),
								$elm$html$Html$Attributes$class('smile-button')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$src('smile_happy.svg')
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Msg$Normal),
								$elm$html$Html$Attributes$class('smile-button')
							]),
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$src('smile_neutral.svg')
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Msg$Sad),
								$elm$html$Html$Attributes$class('smile-button')
							]),
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$src('smile_sad.svg')
									]),
								_List_Nil)
							]))
					]))
...
var $author$project$Msg$ToStep3 = {$: 6};
...
var $author$project$Main$view = function (model) {
	switch (model.$) {
		...
		case 1:
			return $author$project$Intro$viewIntro(0);
		case 2:
			return $author$project$Step1$viewStep1(0);
		case 3:
		...
		default:
			var s = model.a;
			return $author$project$Questionary$viewQuesitonary(s);
	}
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{aD: $author$project$Main$init, aO: $author$project$Main$subscriptions, aR: $author$project$Main$update, aS: $author$project$Main$view});
