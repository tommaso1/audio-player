...
var $author$project$Model$Terms = {$: 'Terms'};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (model.$) {
			case 'AudioPage':
				var m = model.a;
				var _v1 = _Utils_Tuple2(msg, m.playerState);
				switch (_v1.a.$) {
					case 'Tick':
						if (_v1.b.$ === 'Play') {
							var _v2 = _v1.b;
					...
					case 'PlayAudio':
						...
						return _Utils_Tuple2(
							$author$project$Model$AudioPage(
								_Utils_update(
									m,
									{playerState: $author$project$Model$Play})),
					...
					case 'PauseAudio':
						...
						return _Utils_Tuple2(
							$author$project$Model$AudioPage(
								_Utils_update(
									m,
									{playerState: $author$project$Model$Stop})),
			...
			default:
				switch (msg.$) {
					...
					case 'ToAudioPage':
						return _Utils_Tuple2(
							$author$project$Model$AudioPage(
								{playerState: $author$project$Model$Idle, seconds: 0}),
							$elm$core$Platform$Cmd$none);
					default:
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
...
var $author$project$Msg$PauseAudio = {$: 'PauseAudio'};
var $author$project$Msg$PlayAudio = {$: 'PlayAudio'};
...
var $author$project$AudioPage$viewAudioPage = function (model) {
	var second = $author$project$AudioPage$formatSeconds(
		A2($elm$core$Basics$modBy, 60, model.seconds));
	var minutes = $author$project$AudioPage$formatSeconds((model.seconds / 60) | 0);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Msg$ToIntro = {$: 'ToIntro'};
