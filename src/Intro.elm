...
viewIntro () =  div [ class "column-space-between" ] [ 
    ...
    , p [ class "description"  ] [ text "Questa app si basa sulla mindfulness che è un metodo validato che permette di passare da uno stato di tensione e stanchezza a una percezione soggettiva di benessere, grazie alla conoscenza profonda degli stati mentali." ]
    ]
